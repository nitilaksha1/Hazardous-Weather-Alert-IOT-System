...
public class CarDataEncoder implements Encoder<CarData>, Decoder<CarData> {
    private static final Logger LOGGER = Logger.getLogger(CarDataEncoder.class);
    private static ObjectMapper objectMapper = new ObjectMapper();

    public CarDataEncoder() {}

    public CarDataEncoder(VerifiableProperties verifiableProperties) {}
