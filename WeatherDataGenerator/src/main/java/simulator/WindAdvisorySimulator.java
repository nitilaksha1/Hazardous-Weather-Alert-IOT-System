...
@AllArgsConstructor
public class WindAdvisorySimulator implements WeatherDataSimulator {
    private static final Logger LOGGER = Logger.getLogger(WindAdvisorySimulator.class);
    ...
    public void generateWeatherEvent() {
        ...
        LOGGER.info("Sending strong wind weather events ...");
